...
module.exports = msgHandler = async (client, message) => {
	...
	case '!stickernobg':
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/jayyidsptr', donate)
            break
        case '!tts':
        ...
        /*case '!fb':
            ...
            break*/
        case '!creator':
            client.sendContact(from, '6285858124452@c.us')
            break
        /*case '!ig':
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ SOCIAL TWO BOT Broadcast ]\n\n${msg}`)
            }
